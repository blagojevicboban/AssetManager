...
namespace ERPiSredstvaApp.Views.Amortizacija;
...
public class AmortizacijaDocument : IDocument
{
    ...
    public AmortizacijaDocument(List<AmortizacijaResultViewModel> rezultati, ERPiSredstvaData.Models.Firma? firma, DateTime odDatuma, DateTime doDatuma)
    {
