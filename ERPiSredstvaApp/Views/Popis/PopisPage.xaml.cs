...
namespace ERPiSredstvaApp.Views.Popis;
...
public partial class PopisPage : Page
{
    ...
    private void BtnNovaKomisija_Click(object sender, RoutedEventArgs e)
    {
        ...
        var komisija = new ERPiSredstvaData.Models.Komisija
        {
            Naziv = naziv,
    ...
    private void BtnNoviPopis_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (MessageBox.Show("Da li želite da generišete novi popis za tekuću godinu? Ovo će evidentirati sva aktivna osnovna sredstva na popisnu listu.", "Novi popis", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
        {
            ...
            try
            {
                var popis = new ERPiSredstvaData.Models.Popis
                {
    ...
    {
        if (PopisGrid.SelectedItem is ERPiSredstvaData.Models.Popis popis)
        {
    ...
    {
        if (sender is Button btn && btn.Tag is ERPiSredstvaData.Models.Popis popis)
        {
    ...
    {
        if (sender is Button btn && btn.Tag is ERPiSredstvaData.Models.Komisija komisija)
        {
            var result = MessageBox.Show(
    ...
    private ERPiSredstvaData.Models.Komisija? _selectedKomisija;

    private void KomisijeGrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        _selectedKomisija = KomisijeGrid.SelectedItem as ERPiSredstvaData.Models.Komisija;
    ...
    private void BtnDodajClana_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            var noviClan = new ERPiSredstvaData.Models.ClanKomisije
            {
    ...
    {
        if (sender is Button btn && btn.Tag is ERPiSredstvaData.Models.ClanKomisije clan)
        {
            var result = MessageBox.Show(
