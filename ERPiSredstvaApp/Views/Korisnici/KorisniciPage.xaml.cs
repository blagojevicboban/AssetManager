...
public partial class KorisniciPage : Page
{
    ...
    public KorisniciPage(SredstvaDbContext db)
    {
        InitializeComponent();
        _db = db;
    ...
    private void BtnPonistiLozinku_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (korisnik != null)
        {
            ...
            {
                korisnik.LozinkaHash = SredstvaDbContext.HashPassword("123456");
                _db.SaveChanges();
    ...
    private void BtnDeaktiviraj_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (korisnik != null)
        {
            // Ne dozvoljavamo deaktivaciju trenutno ulogovanog admina
