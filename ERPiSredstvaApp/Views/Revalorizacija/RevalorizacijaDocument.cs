...
public class RevalorizacijaDocument : IDocument
{
    ...
    public RevalorizacijaDocument(List<RevalorizacijaResultViewModel> rezultati, ERPiSredstvaData.Models.Firma? firma, DateTime odDatuma, DateTime doDatuma, decimal godKoeficijent)
    {
