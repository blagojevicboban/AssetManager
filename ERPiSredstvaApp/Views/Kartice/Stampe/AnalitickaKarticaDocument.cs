...
namespace ERPiSredstvaApp.Views.Kartice.Stampe;
...
public class AnalitickaKarticaDocument : IDocument
{
    ...
    public AnalitickaKarticaDocument(Sredstvo sredstvo, List<Kartica> kartice, ERPiSredstvaData.Models.Firma? firma)
    {
        _sredstvo = sredstvo;
