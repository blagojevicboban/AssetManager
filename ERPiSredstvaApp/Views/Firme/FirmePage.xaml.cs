...
namespace ERPiSredstvaApp.Views.Firme;
    ...
    private void UcitajPodatke()
    {
        try
        {
            ...
            if (!firmeList.Any())
            {
                ...
                try
                {
                    using var fileDb = SredstvaDbContext.Create(defaultPath);
                    var f = fileDb.Firme.FirstOrDefault();
                    if (f == null)
                    {
                        f = new Firma
    ...
    private void BtnSacuvaj_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            if (_isNew)
            {
                ...
                using var newDb = SredstvaDbContext.Create(dbPathToSave);
                f = new Firma
                {
            ...
            else
            {
                ...
                using var editDb = SredstvaDbContext.Create(dbPathToSave);
